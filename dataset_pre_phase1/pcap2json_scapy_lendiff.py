...
from LLM_feature import token_length as TOKEN_LENGTH
...
if __name__ == '__main__':
    ...
    output_file = "./dataset/dataset_5p_nopre2_train"+str(int(TOKEN_LENGTH))+".json"
    main(file_path, output_file, split_second = 5, min_size = 3*1024)
    file_path = "../dataset_pre_phase0_5/dataset/5pmnkshffm-3/trace/valid"
    output_file = "./dataset/dataset_5p_nopre2_valid"+str(int(TOKEN_LENGTH))+".json"
    main(file_path, output_file, split_second = 5, min_size = 3*1024)
    file_path = "../dataset_pre_phase0_5/dataset/5pmnkshffm-3/trace/test"
    output_file = "./dataset/dataset_5p_nopre2_test"+str(int(TOKEN_LENGTH))+".json"
    main(file_path, output_file, split_second = 5, min_size = 3*1024)
    
    file_path = "../dataset_pre_phase0_5/dataset/ETF IoT/trace/train"
    output_file = "./dataset/ETF_IoT_nopre2_train"+str(int(TOKEN_LENGTH))+".json"
    main(file_path, output_file, split_second = 60, min_size = 0)
    file_path = "../dataset_pre_phase0_5/dataset/ETF IoT/trace/valid"
    output_file = "./dataset/ETF_IoT_nopre2_valid"+str(int(TOKEN_LENGTH))+".json"
    main(file_path, output_file, split_second = 60, min_size = 0)
    file_path = "../dataset_pre_phase0_5/dataset/ETF IoT/trace/test"
    output_file = "./dataset/ETF_IoT_nopre2_test"+str(int(TOKEN_LENGTH))+".json"
    main(file_path, output_file, split_second = 60, min_size = 0)

    file_path = "../dataset_pre_phase0_5/dataset/captures_IoT-Sentinel/trace/train"
    output_file = "./dataset/captures_IoT-Sentinel_nopre2_train"+str(int(TOKEN_LENGTH))+".json"
    ...
    output_file = "./dataset/captures_IoT-Sentinel_nopre2_valid"+str(int(TOKEN_LENGTH))+".json"
    main(file_path, output_file, split_second = 1e5, min_size = 0)
    file_path = "../dataset_pre_phase0_5/dataset/captures_IoT-Sentinel/trace/test"
    output_file = "./dataset/captures_IoT-Sentinel_nopre2_test"+str(int(TOKEN_LENGTH))+".json"
    main(file_path, output_file, split_second = 1e5, min_size = 0)

    file_path = "../dataset_pre_phase0_5/dataset/and50/trace/train"
    output_file = "./dataset/and50_nopre2_train"+str(int(TOKEN_LENGTH))+".json"
    main(file_path, output_file, split_second = 1e5, min_size = 0)
    file_path = "../dataset_pre_phase0_5/dataset/and50/trace/valid"
    output_file = "./dataset/and50_nopre2_valid"+str(int(TOKEN_LENGTH))+".json"
    main(file_path, output_file, split_second = 1e5, min_size = 0)
    file_path = "../dataset_pre_phase0_5/dataset/and50/trace/test"
    output_file = "./dataset/and50_nopre2_test"+str(int(TOKEN_LENGTH))+".json"
    main(file_path, output_file, split_second = 1e5, min_size = 0)
